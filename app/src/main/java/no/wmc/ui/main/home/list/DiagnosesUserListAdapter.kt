...
class DiagnosesUserListAdapter(val context: Context, private var list: ArrayList<AllCategoryModel>) : RecyclerView.Adapter<DiagnosesUserListAdapter.ViewHolder>() {
