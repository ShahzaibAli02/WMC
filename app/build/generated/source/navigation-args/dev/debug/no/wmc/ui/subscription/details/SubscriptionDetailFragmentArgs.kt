...
public data class SubscriptionDetailFragmentArgs(
  public val id: Int
) : NavArgs {
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): SubscriptionDetailFragmentArgs {
      bundle.setClassLoader(SubscriptionDetailFragmentArgs::class.java.classLoader)
      val __id : Int
      ...
      return SubscriptionDetailFragmentArgs(__id)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        SubscriptionDetailFragmentArgs {
      val __id : Int?
