...
public data class EditCardBottomDialogArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): EditCardBottomDialogArgs {
      bundle.setClassLoader(EditCardBottomDialogArgs::class.java.classLoader)
      ...
      return EditCardBottomDialogArgs(__profileItemEnum)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle): EditCardBottomDialogArgs {
      val __profileItemEnum : ProfileItemEnum?
