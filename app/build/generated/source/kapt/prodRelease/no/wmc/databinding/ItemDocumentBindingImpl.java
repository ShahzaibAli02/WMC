...
public class ItemDocumentBindingImpl extends ItemDocumentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.documentList, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.model == variableId) {
            setModel((no.wmc.domain.model.DocumentList.DocumentGroup) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setModel(@Nullable no.wmc.domain.model.DocumentList.DocumentGroup Model) {
        this.mModel = Model;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        no.wmc.domain.model.DocumentList.DocumentGroup model = mModel;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.documentType, modelCategory);
        }
    }
