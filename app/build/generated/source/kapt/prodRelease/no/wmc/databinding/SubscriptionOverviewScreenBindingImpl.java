...
public class SubscriptionOverviewScreenBindingImpl extends SubscriptionOverviewScreenBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.menuButton, 4);
        sViewsWithIds.put(R.id.currentSubscription, 5);
        sViewsWithIds.put(R.id.noSubscriptionLayout, 6);
        sViewsWithIds.put(R.id.noSubscriptionTitle, 7);
        sViewsWithIds.put(R.id.subscriptionList, 8);
        sViewsWithIds.put(R.id.addSubscriptionLayout, 9);
        sViewsWithIds.put(R.id.addSubscriptionButton, 10);
    }
    // views
    @NonNull
    ...
    public SubscriptionOverviewScreenBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private SubscriptionOverviewScreenBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
